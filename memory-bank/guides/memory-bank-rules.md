# Memory Bank Rules & Guidelines

**Purpose:** Core workflow rules for memory-bank documentation
**When to use:** All memory-bank updates and AI navigation tasks
**Quick sections:** Core workflows, update triggers, feature documentation
**Size:** 🟢 (~340 lines)

This file defines the mandatory rules and workflows for maintaining the memory-bank documentation system. It works together with [documentation-framework.md](./documentation-framework.md) for complete standards and [startHere.md](../startHere.md) for navigation.

**Framework Alignment:** This file follows the [Comprehensive Documentation Framework](./documentation-framework.md) and works together with [startHere.md](../startHere.md) for optimal AI navigation.
...
3. **activeContext.md**
   ...
   - Strategic context and detailed status
...
**File Size Reference:** Complete file size standards in [Documentation Framework](./documentation-framework.md#file-size-categorization-system) and [startHere.md](../startHere.md).

#### File Processing Guidelines:
- **Always start with README.md** for any feature to understand scope and navigation
- **Follow task-specific paths** from [startHere.md](../startHere.md) for efficient context usage
...
flowchart TD
    ...
    Navigation -->|AI specific| ReadCore[Read Core Memory Bank]
...
5. **Follow section header standards** from [Documentation Framework](./documentation-framework.md#section-header-standards)
...
7. **When project status changes** (update activeContext.md and other status files)
...
Note: When triggered by **update memory bank**, AI must review every memory-bank file, including checking for new modular feature documentation. Focus particularly on activeContext.md and progress.md as they track current state.

### Update Triggers (MANDATORY)

Update memory-bank immediately when:
1. **Project status changes** (kickoff, milestone completion, phase transition)
2. **New action items identified** (from meetings, discoveries, blockers resolved)
3. **Architecture decisions made** (new patterns, technology choices)
4. **Feature scope changes** (requirements added/removed, priorities shift)
5. **Implementation patterns discovered** (new techniques, optimization opportunities)
6. **Minimum weekly** (even if no major changes, verify accuracy)

### Production Deployment Rule

When a task requires applying changes to a production environment:
1. **Always verify production environment variables** are correctly configured
2. **Never use localhost fallbacks** in production code paths
3. **Fail fast with clear error messages** when required configuration is missing
4. **Test in production-like environments** before deploying to production

This is a critical project-specific workflow that prevents production configuration errors.
...
- **AI processing optimization:** Follow [startHere.md](../startHere.md) for context efficiency
...
- **Section headers:** Use [standardized format](./documentation-framework.md#section-header-standards) for consistent navigation
...
The project intelligence system (such as .cursorrules or similar configuration files) captures important patterns, preferences, and project intelligence that help AI assistants work more effectively. As AI works with the project, it should discover and document key insights that aren't obvious from the code alone.
...
flowchart TD
    ...
    subgraph Learn [Learning Process]
        ...
        D3[Document in Project Config]
        D4[Update Documentation Framework]
    end

    subgraph Apply [Usage]
        A1[Read Project Configuration]
...
The format is flexible - focus on capturing valuable insights that help AI work more effectively with the project. Think of project configuration as a living document that grows smarter as work progresses.
...
This file integrates with the broader documentation ecosystem:

**Framework Alignment:** This Cursor-specific workflow integrates with the broader [Documentation Framework](./documentation-framework.md) and [Navigation System](../startHere.md) to provide optimal AI assistant performance across all tools and contexts.

**Key Integration Points:**
- [startHere.md](../startHere.md) - Master navigation hub
- [documentation-framework.md](./documentation-framework.md) - Complete standards
- [executive-summaries.md](./executive-summaries.md) - Large file navigation guide

REMEMBER: AI assistants have context limitations. The Memory Bank and navigation system are designed specifically to address these limitations and must be maintained with precision and clarity. Effectiveness depends entirely on the accuracy and proper structure of this documentation.
